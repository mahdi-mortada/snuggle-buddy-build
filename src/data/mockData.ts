import type { Incident, RiskScore, Alert, DashboardStats, TrendDataPoint, SourceInfo } from '@/types/crisis';

// === Lebanese Media Sources ===
const sources: Record<string, SourceInfo> = {
  lbci: { name: 'LBCI', type: 'tv', credibility: 'verified', credibilityScore: 88, logoInitials: 'LB', url: 'https://www.lbci.com', verifiedBy: ['Reuters', 'AFP'] },
  mtv: { name: 'MTV Lebanon', type: 'tv', credibility: 'verified', credibilityScore: 85, logoInitials: 'MT', url: 'https://www.mtv.com.lb' },
  otv: { name: 'OTV', type: 'tv', credibility: 'moderate', credibilityScore: 62, logoInitials: 'OT', url: 'https://www.otv.com.lb' },
  almanar: { name: 'Al Manar', type: 'tv', credibility: 'low', credibilityScore: 40, logoInitials: 'AM' },
  aljadeed: { name: 'Al Jadeed', type: 'tv', credibility: 'high', credibilityScore: 78, logoInitials: 'AJ', url: 'https://www.aljadeed.tv' },
  nna: { name: 'NNA (National News Agency)', type: 'news_agency', credibility: 'verified', credibilityScore: 90, logoInitials: 'NN', url: 'https://nna-leb.gov.lb', verifiedBy: ['Government of Lebanon'] },
  lorient: { name: "L'Orient Today", type: 'newspaper', credibility: 'verified', credibilityScore: 92, logoInitials: 'LO', url: 'https://today.lorientlejour.com', verifiedBy: ['AFP', 'AP'] },
  naharnet: { name: 'Naharnet', type: 'newspaper', credibility: 'high', credibilityScore: 80, logoInitials: 'NH', url: 'https://www.naharnet.com' },
  dailystar: { name: 'The Daily Star', type: 'newspaper', credibility: 'high', credibilityScore: 82, logoInitials: 'DS', url: 'https://www.dailystar.com.lb' },
  twitter: { name: 'X (Twitter)', type: 'social_media', credibility: 'unverified', credibilityScore: 25, logoInitials: 'X' },
  telegram_src: { name: 'Telegram Channels', type: 'social_media', credibility: 'low', credibilityScore: 30, logoInitials: 'TG' },
  lebanese_army: { name: 'Lebanese Armed Forces', type: 'government', credibility: 'verified', credibilityScore: 93, logoInitials: 'LA', verifiedBy: ['Government of Lebanon'] },
  redcross_lb: { name: 'Lebanese Red Cross', type: 'ngo', credibility: 'verified', credibilityScore: 95, logoInitials: 'RC', verifiedBy: ['ICRC'] },
};
...
export const mockIncidents: Incident[] = [
  { id: '1', source: 'lbci', sourceInfo: sources.lbci, title: 'Large gathering reported near Martyrs Square', description: 'Multiple social media posts indicating a growing crowd near downtown Beirut.', category: 'protest', severity: 'high', location: { lat: 33.8938, lng: 35.5018 }, locationName: "Martyrs' Square", region: 'Beirut', sentimentScore: -0.72, riskScore: 78, entities: ['Beirut', 'Martyrs Square'], keywords: ['protest', 'gathering', 'crowd'], status: 'escalated', createdAt: new Date(Date.now() - 300000).toISOString(), corroboratedBy: [sources.mtv, sources.aljadeed] },
  { id: '2', source: 'nna', sourceInfo: sources.nna, title: 'Power grid failure in Tripoli industrial zone', description: 'Major power outage affecting northern industrial facilities.', category: 'infrastructure', severity: 'critical', location: { lat: 34.4367, lng: 35.8497 }, locationName: 'Tripoli Industrial Zone', region: 'North Lebanon', sentimentScore: -0.85, riskScore: 89, entities: ['Tripoli', 'EDL'], keywords: ['power outage', 'infrastructure', 'emergency'], status: 'new', createdAt: new Date(Date.now() - 120000).toISOString(), corroboratedBy: [sources.lbci, sources.lorient] },
  { id: '3', source: 'mtv', sourceInfo: sources.mtv, title: 'Flooding alerts in Bekaa Valley', description: 'Heavy rainfall causing flash flooding in agricultural areas.', category: 'natural_disaster', severity: 'high', location: { lat: 33.8463, lng: 35.9019 }, locationName: 'Bekaa Valley', region: 'Bekaa', sentimentScore: -0.65, riskScore: 72, entities: ['Bekaa Valley'], keywords: ['flood', 'rain', 'disaster'], status: 'analyzed', createdAt: new Date(Date.now() - 600000).toISOString(), corroboratedBy: [sources.redcross_lb] },
  { id: '4', source: 'lorient', sourceInfo: sources.lorient, title: 'Cyber attack targeting banking sector', description: 'Reports of coordinated phishing campaigns against Lebanese banks.', category: 'cyber', severity: 'critical', location: { lat: 33.8886, lng: 35.4955 }, locationName: 'Hamra District', region: 'Beirut', sentimentScore: -0.91, riskScore: 92, entities: ['Bank of Lebanon', 'Hamra'], keywords: ['cyber', 'attack', 'phishing', 'banking'], status: 'escalated', createdAt: new Date(Date.now() - 60000).toISOString(), corroboratedBy: [sources.dailystar, sources.nna] },
  { id: '5', source: 'telegram_src', sourceInfo: sources.telegram_src, title: 'Health clinic overwhelmed in Sidon', description: 'Local clinic reports surge in respiratory illness cases.', category: 'health', severity: 'medium', location: { lat: 33.5633, lng: 35.3697 }, locationName: 'Sidon', region: 'South Lebanon', sentimentScore: -0.45, riskScore: 55, entities: ['Sidon', 'Ministry of Health'], keywords: ['health', 'clinic', 'respiratory'], status: 'processing', createdAt: new Date(Date.now() - 900000).toISOString() },
  { id: '6', source: 'aljadeed', sourceInfo: sources.aljadeed, title: 'Roadblock on Beirut-Damascus highway', description: 'Unidentified groups have set up roadblocks along the main highway.', category: 'violence', severity: 'high', location: { lat: 33.8700, lng: 35.7500 }, locationName: 'Dahr el Baydar', region: 'Mount Lebanon', sentimentScore: -0.78, riskScore: 81, entities: ['Beirut-Damascus Highway'], keywords: ['roadblock', 'highway', 'security'], status: 'new', createdAt: new Date(Date.now() - 180000).toISOString(), corroboratedBy: [sources.lbci] },
  { id: '7', source: 'lebanese_army', sourceInfo: sources.lebanese_army, title: 'Suspicious package found near Jounieh port', description: 'Authorities investigating reports of unattended package.', category: 'terrorism', severity: 'critical', location: { lat: 33.9808, lng: 35.6178 }, locationName: 'Jounieh Port', region: 'Mount Lebanon', sentimentScore: -0.88, riskScore: 85, entities: ['Jounieh', 'LAF'], keywords: ['suspicious', 'package', 'port', 'investigation'], status: 'escalated', createdAt: new Date(Date.now() - 30000).toISOString(), corroboratedBy: [sources.nna, sources.lbci, sources.mtv] },
  { id: '8', source: 'twitter', sourceInfo: sources.twitter, title: 'Air quality deterioration in Baalbek', description: 'Sensor readings show PM2.5 levels exceeding safe thresholds.', category: 'health', severity: 'low', location: { lat: 34.0047, lng: 36.2110 }, locationName: 'Baalbek', region: 'Bekaa', sentimentScore: -0.20, riskScore: 35, entities: ['Baalbek', 'EPA'], keywords: ['air quality', 'pollution', 'PM2.5'], status: 'analyzed', createdAt: new Date(Date.now() - 1800000).toISOString() },
];
